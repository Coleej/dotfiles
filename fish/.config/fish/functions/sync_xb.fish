function sync_xb
  ...
  case "dell-desk"
    rsync -avr --delete --exclude-from=/home/cjohnson/.rsync_xbeach_excludes --filter='P *.nc' cjoh296@qb.loni.org:/work/cjoh296/xbeach.wd/ /home/cjohnson/Modeling/xbeach
  end
end
